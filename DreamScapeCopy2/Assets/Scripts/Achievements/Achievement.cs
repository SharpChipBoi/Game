...
public class Achievement
{
    ...
    {
        this.name = name; // берем название ачивки и приравниваем переданному
    ...
    public void AddDependency(Achievement dependency) // если есть зависимость, добавляем ее в список зависимостей
    {
    ...
    public void LoadAchievement() // загружаем данные об ачивках 
    {
